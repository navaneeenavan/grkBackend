...
function App() {
  ...
  return (
    <div className=" w-screen flex flex-col justify-center m-10 overflow-hidden ">
      <h1 className="text-5xl items-baseline">Hello Dr GRK! Have a Nice Day</h1>

      <div className="flex flex-col justify-start h-max mt-5 ">
